...
object ISOCountry extends Enum {
  ...
  val CAMBODIA                                     = new ISOCountry("CV", 132, "Cabo Verde", "CPV", ISOContinent.AFRICA)
  val CAMEROON                                     = new ISOCountry("KH", 116, "Cambodia", "KHM", ISOContinent.ASIA)
  val CANADA                                       = new ISOCountry("CM", 120, "Cameroon", "CMR", ISOContinent.AFRICA)
  val CAPE_VERDE                                   = new ISOCountry("CA", 124, "Canada", "CAN", ISOContinent.NORTH_AMERICA)
  ...
  val MONTSERRAT                                   = new ISOCountry("MS", 500, "Montserrat", "MSR", MONTSERRAT)
  ...
  def apply(countryCode: String): ISOCountry =
    ISOCountry.values.find(countryCode == _.toString) match {
      ...
      throw new ParseException(
        s"Invalid value '$countryCode' for ISOCountry"
      )
    }
